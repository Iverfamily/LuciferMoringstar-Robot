...
# Creator
CREATOR_NAME = os.environ.get("CREATOR_NAME", "kristyan")
CREATOR_USERNAME = os.environ.get("CREATOR_USERNAME", "moviesclubowne")
...
SUPPORT_CHAT = os.environ.get("SUPPORT_CHAT", "Moviesclubs77")
AUTH_CHANNEL = os.environ.get("AUTH_CHANNEL", "-1001382206171")
CHANNELS = [int(ch) if search.search(ch) else ch for ch in os.environ.get("CHANNELS", "-1001784382279").split()]
LOG_CHANNEL = os.environ.get("LOG_CHANNEL", "-1001524483029")
GET_FILECHANNEL = os.environ.get("GET_FILECHANNEL", "-1001778894883")
